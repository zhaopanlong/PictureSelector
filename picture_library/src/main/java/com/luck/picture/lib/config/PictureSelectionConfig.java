...
public final class PictureSelectionConfig implements Parcelable {
    public static String defaultOutPutCameraPath = "";
    public static String defaultSandboxFolderPath = "";
    public static String defaultCompressSavePath = "";
    ...
    protected void initDefaultValue() {
        ...
        circleStrokeWidth = 1;
        isDragFrame = true;
        compressSavePath = defaultCompressSavePath;
        suffixType = "";
        cameraImageFormat = "";
        cameraVideoFormat = "";
        cameraAudioFormat = "";
        ...
        outPutCameraPath = defaultOutPutCameraPath;
        sandboxFolderPath = defaultSandboxFolderPath;
        originalPath = "";
        cameraPath = "";
        cameraMimeType = -1;
